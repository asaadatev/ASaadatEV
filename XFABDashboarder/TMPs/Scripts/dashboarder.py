...
## Create dashboards ##
 ...
 %run "D:\ASaadat\PythonCode\XFABDashboarder\TMPs\Scripts\derived_parameters.py"
...
def interactive_plot_system_data_1(data,
    ...
    #stiindicator_plots = DP_computer(file_path=DHou_file_path, dash_folder=DATA_FILES_DIR)

"""Class for Computing trend-related derived parameter in a way supported by
PdM."""
...
class PdMTrend(Base):
    """
    Compute trend-related derived parameter in a way supported by PdM.
    ...
    4. Compare derived parameter against thresholds to get alert periods
    (`threshold`, `is_upper`, `t_min_high`, `t_min_low`)

    See Also
    --------
    Base : the base class for all derived parameters.
    Trend : class for computing trend-related derived parameter.

    Examples
    -----
    See 'example/dp/pdm_trend.ipynb'.
    """
    ...
    def process(self, src):
        ...
        if self.data is not None:
            ...
            # (4) Compare against thresholds to get alert periods

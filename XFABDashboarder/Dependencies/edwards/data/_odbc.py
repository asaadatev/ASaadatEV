...
class Odbc:
    ...
    # SERVER = r'20.0.0.8\FABWORKS' # Access database from 20. network
    SERVER = r'10.44.221.8\FABWORKS'  # Access database from other networks
    UID = 'sa'
    PWD = '!Tat00ine'
    ...
    def __init__(self,
        ...
        warnings.warn(
            "the class `edwards.data.Odbc` is deprecated "
            "and will be removed completely from the package on 2022-09-01."
            "please use `edwards.loader.Odbc` instead. "
            "For details, see examples/loader/odbc.ipynb",
            UserWarning,
        )

...
database = 'scada_Production_Micron_F15'
...
sys_query = 'select * from dbo.fst_GEN_System where Description like \'iH1000%\''

systems_info = pd.read_sql_query(sys_query, con=db_connection)

systems = list(systems_info.Description.unique())
...
#         return part_data
    ...
    if save:
        io.output_file(os.path.join(save_dest, 
                                    f"{system_position} {system} params_concealed.html"))
...
customer_account_name = 'XFAB_France'                
